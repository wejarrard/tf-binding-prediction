...
def process_data(chipseq_bed_path, atacseq_bed_path, blacklist_bed_path, pileup_dir, output_path, total_reads):
    ...
    # Subtract the original chipseq_bed from atacseq_only_peaks, not including this because this is the test set
    ...
    for main_df, category in [(df_intersecting, 'intersecting'),
        ...
        for chrom in main_df['chrom'].unique():
            ...
            for split_df, split in [(chrom_df, "test")]:
...
# --chipseq-bed-path ./data/SRX10030477.bed \
# --atacseq-bed-path ./data/SRX7023024.filtered.narrowPeak \
# --atacseq-bam-path ./data/SRX7023024.bowtie.sorted.nodup.bam \
